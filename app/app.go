...
func init() {
	...
	sdk.DefaultPowerReduction = sdk.NewIntFromBigInt(new(big.Int).Exp(big.NewInt(10), big.NewInt(BaseDenomUnit), nil))
}
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		feemarkettypes.StoreKey, evmtypes.StoreKey,
		tspchainmoduletypes.StoreKey,
	...
	*/
	...
	app.TspchainKeeper = *tspchainmodulekeeper.NewKeeper(
		appCodec,
		keys[tspchainmoduletypes.StoreKey],
		keys[tspchainmoduletypes.MemStoreKey],
		app.GetSubspace(tspchainmoduletypes.ModuleName),
	)
	tspchainModule := tspchainmodule.NewAppModule(appCodec, app.TspchainKeeper, app.AccountKeeper, app.BankKeeper)
	...
	app.mm.SetOrderBeginBlockers(
		...
		evmtypes.ModuleName,
		tspchainmoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(tspchainmoduletypes.ModuleName)
